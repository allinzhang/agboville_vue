...
export class ProjectWbsService {
  ...
  static async detail(params: ProjectWbs): Promise<HttpResponse> {
    return Axios("/web/prowbs/add", {
      method: "GET",
      responseType: "json",
      params: {
        ...params,
  ...
  static async create(params: ProjectWbs): Promise<HttpResponse> {
    return Axios("/web/prowbs/add", {
      method: "POST",
      responseType: "json",
      data: {
  ...
  static async update(params: ProjectWbs): Promise<HttpResponse> {
    return Axios("/web/prowbs/update", {
      method: "POST",
      responseType: "json",
      data: {
        ...params,
  ...
  static async delete(params: deleteParam): Promise<HttpResponse> {
    return Axios("/web/prowbs/delete", {
      method: "POST",
      responseType: "json",
      data: {
        ...params,
